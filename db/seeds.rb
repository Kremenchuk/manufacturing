...
materials = [['Уголок 34х34', 'м/п', 15.52, 0.7, 'РОЛФОРМ'], ['Лист 2х1х0,7 Оц', 'шт', 283.0, 10.4],
    ...
    ['Штрипса 100х1,5 ХК', 'м/п', 27.4, 1.17, 'Бис групп'], ['Лист 2х1х2', 'шт', 770.0, 32.1, 'Бис групп'],
...
workers = [['Чмель', 'Александр', 'Валеревич', 'Сварщик'], ['Томин', 'Сергей', 'Викторович', 'Штамповщик'], ['Цыкал', 'Сергей', '', 'Маляр']]
